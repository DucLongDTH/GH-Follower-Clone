...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func createFavoritesNC() -> UINavigationController {
        let favotitesNC =  FavoritesListVC()
        favotitesNC.title = "Favorites"
        favotitesNC.tabBarItem = UITabBarItem(tabBarSystemItem: .favorites, tag: 1)
        return UINavigationController(rootViewController: favotitesNC)
    }
